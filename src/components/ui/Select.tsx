  ...
  return (
    <Listbox value={selected} onChange={setSelected}>
      ...
      <div className="relative">
        ...
        <ListboxOptions
          transition
          className="absolute z-10 mt-1 max-h-39 sm:max-h-46 w-full overflow-auto rounded-md bg-gray-800 py-1 text-base outline-1 -outline-offset-1 outline-white/10 data-leave:transition data-leave:duration-100 data-leave:ease-in data-closed:data-leave:opacity-0 sm:text-sm"
        >
